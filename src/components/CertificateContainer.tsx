...
const CertificateFormContainer = () => {
  ...
  />
        ...
        >
          <p>Having trouble? &nbsp; Mail to <a href="mailto:algoqueen@cb.amrita.edu" className="text-black underline hover:text-gray-600 transition-colors">algoqueen@cb.amrita.edu</a></p>
        </motion.div>
      </motion.div>
    </div>
  );
